...
#[AllowDynamicProperties] class AppAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function __construct(private UrlGeneratorInterface $urlGenerator,UserService $userService, private ObjectManager $entityManager,RouterInterface $router,
    )
    {
